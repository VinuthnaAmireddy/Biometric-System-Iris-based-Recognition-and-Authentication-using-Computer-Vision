...
class Ui_MainWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "IRIS BIOMETRIC SYSTEM"))
        ...
        self.statusPrompt.setText(_translate("MainWindow", "IRIS BIOMETRIC SYSTEM"))
...
#==================================== GUI FOR PROGRAM ====================================
            ...
            if self.is_verify == 1:
                ...
                while(self.is_verify == 1):
                    ...
                    for face in faces:
                        ...
                        cv2.rectangle(frame, (x-20,y-20), (x1+20,y1+20), (255,255,255), 1) # form a rectangle based on previous two coordinates
                        cv2.line(frame, (x+10, y-20), (x+65, y-55), (255,255,255), 1)
                        cv2.putText(frame, 'FACE IDENTIFIED', (x+70, y-60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,255,0), 2) #show text
                        ...
                        cv2.rectangle(frame, (x-20,y-20), (x1+20,y1+20), (255,255,255), 1) # form a rectangle based on previous two coordinates
                        cv2.line(frame, (x+10, y-20), (x+65, y-55), (255,255,255), 1)
                        cv2.putText(frame, 'FACE IDENTIFIED', (x+70, y-60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255,255,255), 2) #show text                    
                        poslandmarkpoints = predictor(gray, face)
    ...
    def ShowAllRegisteredUsers(self): 
        ...
        col_headers = ['ID NUM.', 'NAME', 'AGE', 'GENDER', 'DATE REGIST.', 'CURRENT DATE', 'INFO.']
